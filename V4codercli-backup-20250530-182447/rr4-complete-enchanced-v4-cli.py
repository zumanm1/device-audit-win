...
try:
    ...
    # Add the renamed directories to Python path
    core_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'rr4_complete_enchanced_v4_cli_core')
    tasks_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'rr4_complete_enchanced_v4_cli_tasks')
    ...
    from rr4_complete_enchanced_v4_cli_core.task_executor import TaskExecutor, ProgressReporter
    ...
    from rr4_complete_enchanced_v4_cli_tasks import get_layer_collector, get_available_layers, validate_layers
...
class ProjectStructure:
    ...
    def create_structure(self):
        ...
        for dir_path in self.required_dirs:
            ...
            if dir_path in ['rr4-complete-enchanced-v4-cli-core', 'rr4-complete-enchanced-v4-cli-tasks']:
