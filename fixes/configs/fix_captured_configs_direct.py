...
# Create a direct replacement for the captured_configs route
replacement_code = """
...
# Write the replacement code to a file
with open('/root/za-con/captured_configs_replacement.py', 'w') as f:
    f.write(replacement_code)

print("Created replacement code for the captured_configs route.")
print("To apply this fix:")
print("1. Open the file /root/za-con/rr3-router.py in a text editor")
print("2. Find the existing captured_configs route (search for '@app.route('/captured_configs')')")
print("3. Replace the entire route with the content from /root/za-con/captured_configs_replacement.py")
