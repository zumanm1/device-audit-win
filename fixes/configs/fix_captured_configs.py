...
def fix_captured_configs_route(input_filepath, output_filepath):
    ...
    captured_configs_replacement = r"""def captured_configs():
...
"""
    ...
    html_template_replacement = r"""HTML_CAPTURED_CONFIGS_TEMPLATE = \"\"\"{% extends "base_layout.html" %}
{% block content %}
...
\"\"\""""
    ...
    view_config_template_replacement = r"""HTML_VIEW_CONFIG_TEMPLATE = \"\"\"
