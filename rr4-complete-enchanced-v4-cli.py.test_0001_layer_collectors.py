...
from tasks.health_collector import HealthCollector, HealthCommands
from tasks.interface_collector import InterfaceCollector
from tasks.igp_collector import IGPCollector
from tasks.mpls_collector import MPLSCollector
from tasks.bgp_collector import BGPCollector
from tasks.vpn_collector import VPNCollector
from tasks.static_route_collector import StaticRouteCollector
