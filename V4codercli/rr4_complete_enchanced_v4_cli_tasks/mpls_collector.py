...
class MPLSCollector(BaseCollector):
    ...
    def collect_layer_data(self, connection: Any, hostname: str, platform: str,
        ...
        # Debug logging to identify None platform issue
        self.logger.debug(f"MPLS collect_layer_data called with: hostname={hostname}, platform={platform}")
